...
export const env: EnvironmentConfig = {
  ...
  maxProfileImageSize: process.env.MAX_PROFILE_IMAGE_SIZE ? parseInt(process.env.MAX_PROFILE_IMAGE_SIZE, 10) : 5242880,
  maxTaskFileSize: process.env.MAX_TASK_FILE_SIZE ? parseInt(process.env.MAX_TASK_FILE_SIZE, 10) : 10485760,
  maxMemoryFileSize: process.env.MAX_MEMORY_FILE_SIZE ? parseInt(process.env.MAX_MEMORY_FILE_SIZE, 10) : 10485760,
