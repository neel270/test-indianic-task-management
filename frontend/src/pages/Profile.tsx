...
import { selectUser, selectIsAuthenticated, loadUserProfile } from '@/store/slices/authSlice';
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-center">
                <Avatar className="h-32 w-32">
                  <AvatarImage 
                    src={previewUrl || (user.profileImage ? `${user.profileImage}?t=${Date.now()}` : undefined)} 
                    alt={user.name} 
                  />
