...
const Home: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Assign tasks to team members, share updates, and maintain transparency across your organization.',
    ...
    },
    {
      ...
      description: 'Get insights into team productivity, track completion rates, and identify bottlenecks.',
    ...
    },
    {
      ...
      description: 'Stay synchronized with instant notifications and live updates across all devices.',
    ...
    },
    {
      icon: Clock,
      title: 'Time Tracking',
      description: 'Monitor time spent on tasks and projects to improve estimation and productivity.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              {isAuthenticated() ? (
                <>
                  <Badge variant="outline">Welcome, {user ? `${user.firstName} ${user.lastName}` : ''}</Badge>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            ...
            track, and complete projects efficiently. Join thousands of teams
            already saving time and getting more done.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4">
                The complete task management solution for modern teams.
                Organize, track, and complete projects with ease.
              </p>
            </div>
